config.vm.define "branch-sw-1" do |node|
  node.vm.guest = :linux
  node.vm.box = "aarna/cumulus-vx-5.11.1"
  ...
  tunnels = [
    { iface: "swp1", lip: "127.3.11.2", lport: 10311, rip: "127.3.11.1", rport: 10311 }, # -> cisco router
    { iface: "swp2", lip: "127.3.12.1", lport: 10312, rip: "127.3.12.2", rport: 10312 }, # -> LAN host
  ]
